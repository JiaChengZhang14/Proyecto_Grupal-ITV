...
class TrabajadorStorageCsv(
    ...
    */
    ...
    fun exportarCsv(items: List<Trabajador>){
        ...
        items.forEach {
            file.appendText("${it.idTrabajador};${it.idEstacion};${it.nombre};${it.telefono};${it.email};${it.nombreUsuario};${it.contraseñaUsuario};${it.fechaContratacion};${it.especialidades.joinToString(separator = "|", prefix = "[", postfix = "]")};${it.idResponsable};${it.informes.toCsv()};${it.salario}" + "\n")
        }
    }
